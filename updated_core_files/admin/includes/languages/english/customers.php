...
// Additions for Customer 360 Reporting
define('TEXT_INFO_LIFETIME_VALUE', 'Customer Lifetime Value:');
define('TEXT_CUSTOMER_NOT_MASTER', 'Customer is not the master account.'); 
define('TEXT_CUSTOMER_TRUE_MASTER', 'True Master: '); 
define('TEXT_CUSTOMER_MASTER_LIFETIME_VALUE', 'Master Lifetime Value: '); 
